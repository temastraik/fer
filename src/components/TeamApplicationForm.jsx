// src/components/TeamApplicationForm.jsx
...
const TeamApplicationForm = ({ competitionId, user, onSuccess, onCancel }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Проверяем наличие уже существующей заявки
      const existingApplication = await checkExistingApplication(competitionId, selectedTeamId);
      ...
      // Отправляем заявку
      await submitTeamApplication(applicationData);
  ...
  return (
    <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* Дополнительные поля при неполной команде */}
        {isIncomplete && (
          <>
            <div className="mb-4">
